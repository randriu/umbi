...
from umbi.datatypes import CommonType, Numeric, Interval, JsonLike
...
@no_type_check
def common_value_to_bytes(value: Numeric | Interval | str | JsonLike, type: CommonType, little_endian: bool = True) -> bytes:
...
def bytes_to_common_value(data: bytes, type: CommonType, little_endian: bool = True) -> Numeric | Interval | str | JsonLike:
